...
// COOPERATION SECTION
// ==================================
export type CooperationSectionData = {
    id: number;
    title: string;
    description: string;
    form_title: string;
...
const rawDevNotes: Record<Language, Omit<DevNote, 'id' | 'lang'>[]> = {
  en: [
    { 
  ...
  en: [
    {
      ...
      skills: [
        "JavaScript", "TypeScript", "Python", "Java", "C#", "C++", "Go", "Rust", "SQL", "HTML5", "CSS", "Bash",
        "React", "Next.js", "Node.js", "Express.js", "React Native", "Spring Boot", "ASP.NET Core", "TensorFlow", "Prisma",
        "Git", "Docker", "Kubernetes", "Firebase", "Vercel", "PostgreSQL", "MongoDB", "GraphQL", "REST API", "TailwindCSS", "Linux", "Adobe", "AWS", "Azure", "Jira", "Visual Studio Code", "IntelliJ IDEA",
...
const rawCooperationSectionData: Record<Language, Omit<CooperationSectionData, 'id'>> = {
    en: {
        title: 'Cooperate With Us',
        description: 'We are actively seeking partnerships with tech enthusiasts, investors, and distributors who share our vision. If you believe in the future of smart wellness technology, let\'s connect and explore how we can innovate together.',
        form_title: 'Send Us Your Proposal',
        name_label: 'Your Name or Company',
        name_placeholder: 'e.g., John Doe / Innovate Inc.',
        email_label: 'Contact Email',
        email_placeholder: 'e.g., john.doe@innovate.com',
        phone_label: 'Phone (Optional)',
        phone_placeholder: 'e.g., +1 (555) 123-4567',
        proposal_label: 'Your Message or Proposal',
        proposal_placeholder: 'Briefly describe your interest or proposal...',
        submit_button_text: 'Submit Proposal'
    },
    uk: {
        title: 'Співпрацюйте з нами',
        description: 'Ми активно шукаємо партнерів серед технічних ентузіастів, інвесторів та дистриб\'юторів, які поділяють наше бачення. Якщо ви вірите в майбутнє технологій розумного здоров\'я, давайте зв\'яжемося та дослідимо, як ми можемо впроваджувати інновації разом.',
        form_title: 'Надішліть нам свою пропозицію',
        name_label: 'Ваше ім\'я або компанія',
        name_placeholder: 'напр., Іван Іванов / Innovate Inc.',
        email_label: 'Контактний Email',
        email_placeholder: 'напр., ivan.ivanov@innovate.com',
        phone_label: 'Телефон (необов\'язково)',
        phone_placeholder: 'напр., +380 (50) 123-4567',
        proposal_label: 'Ваше повідомлення або пропозиція',
        proposal_placeholder: 'Коротко опишіть свою зацікавленість або пропозицію...',
        submit_button_text: 'Надіслати пропозицію'
    },
    sk: {
        title: 'Spolupracujte s nami',
        description: 'Aktívne hľadáme partnerstvá s technologickými nadšencami, investormi a distribútormi, ktorí zdieľajú našu víziu. Ak veríte v budúcnosť technológií inteligentného wellness, spojme sa a preskúmajme, ako môžeme spoločne inovovať.',
        form_title: 'Pošlite nám svoj návrh',
        name_label: 'Vaše meno alebo spoločnosť',
        name_placeholder: 'napr., Ján Vážny / Innovate Inc.',
        email_label: 'Kontaktný e-mail',
        email_placeholder: 'napr., jan.vazny@innovate.com',
        phone_label: 'Telefón (voliteľné)',
        phone_placeholder: 'napr., +421 912 345 678',
        proposal_label: 'Vaša správa alebo návrh',
        proposal_placeholder: 'Stručne opíšte svoj záujem alebo návrh...',
        submit_button_text: 'Odoslať návrh'
    }
};
...
const devNotes: Record<Language, Omit<DevNote, 'id'>[]> = {
  en: rawDevNotes.en.map(n => ({...n, lang: 'en'})),
  uk: rawDevNotes.uk.map(n => ({...n, lang: 'uk'})),
  sk: rawDevNotes.sk.map(n => ({...n, lang: 'sk'})),
};
...
export const initialData = {
    ...
    cooperationSectionData: rawCooperationSectionData,
};
