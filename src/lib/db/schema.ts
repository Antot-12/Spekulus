...
export const cooperationSections = pgTable('cooperation_sections', {
  id: serial('id').primaryKey(),
  lang: varchar('lang', { length: 2 }).notNull().references(() => languages.code).unique(),
  title: text('title').notNull(),
  description: text('description').notNull(),
  form_title: text('form_title').notNull(),
  name_label: text('name_label').notNull(),
  name_placeholder: text('name_placeholder').notNull(),
  email_label: text('email_label').notNull(),
  email_placeholder: text('email_placeholder').notNull(),
  phone_label: text('phone_label').notNull(),
  phone_placeholder: text('phone_placeholder').notNull(),
  proposal_label: text('proposal_label').notNull(),
  proposal_placeholder: text('proposal_placeholder').notNull(),
...
(t) => ({
    slugLangUnique: unique().on(t.slug, t.lang),
}));
...
export const creators = pgTable(
  'creators',
  {
    ...
    isVisible: boolean('is_visible').default(true).notNull(),
    socials: jsonb('socials').$type<{ twitter?: string; github?: string; linkedin?: string; gitlab?: string; discord?: string; website?: string; facebook?: string; instagram?: string; }>(),
