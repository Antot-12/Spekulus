...
const dashboardItems = [
  ...
  { href: "/admin/cooperation-section", icon: <Handshake />, title: "Cooperation Section", description: "Manage the 'Cooperate With Us' section text and form fields.", buttonText: "Manage Section" },
